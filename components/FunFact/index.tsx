        ...
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
          ...
          >
            ...
            <p className="mx-auto lg:w-11/12">
              Thống kê về tôn giáo ở Việt Nam(tính đến 5/2024)
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Nhà nước công nhận</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Theo tôn giáo</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Tôn giáo đông nhất(6,1% dân số)</p>
            </motion.div>
          </div>
        </div>
      </section>
